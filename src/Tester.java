...
/**
 * Write a description of class Sutest here.
 *
 * @author (your name)
...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Checking two numbers in a row: ");
        fillSudoku(square3x3Arr);
        int val = square3x3Arr[0][0].getCell(1,0);
        square3x3Arr[0][0].setXY(1, 1, val);
        Sudoku s3 = new Sudoku(square3x3Arr);
        if (!s3.isValid()) System.out.println(ANSI_GREEN + "Returned OK" + ANSI_RESET);
        else System.out.println(ANSI_RED + "Returned ERROR" + ANSI_RESET + "- Check if you have a validation for two numbers in the same row");

        System.out.print("Checking two numbers in a column: ");
        fillSudoku(square3x3Arr);
        val = square3x3Arr[0][1].getCell(0,2); // in board 0,1 at cell 0,2
        square3x3Arr[0][0].setXY(0, 1, val); // in board 0,0 at cell 0,1
        s3 = new Sudoku(square3x3Arr);
        if (!s3.isValid()) System.out.println(ANSI_GREEN + "Returned OK");
        else System.out.println(ANSI_RED + "Returned ERROR" + ANSI_RESET + "- Check if you have a validation for two numbers in the same column");
